...
public class LeaderElectionSupport implements Watcher {
   ...
   * @throws KeeperException in case the hostname is not available
   ...
   * 
   * @param listener to be notified about state changes
   */
   ...
   * 
   * @param listener to be removed from notification change updates.
   */
   ...
   * wish to contend for leader status need to use the same root node. Note: We
   * assume this node already exists.
   * @param rootNodeName name of the root node in ZK
   * </p>
   */
